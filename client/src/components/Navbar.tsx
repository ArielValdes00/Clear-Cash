...
const Navbar: React.FC<ThemeProps> = ({ handleChangeTheme, toggleButton }) => {
    return (
        <div className='grid grid-cols-3 md:grid-cols-9 items-center px-4 lg:px-5 py-1'>
            ...
            <div className='mt-[15px] mx-auto md:ml-auto lg:ml-12 xl:ml-24 md:col-start-8'>
                <label
                    htmlFor={'check'}
            ...
            <button className='shadow ml-auto md:col-start-9 px-4 lg:py-2 py-[6px] font-semibold rounded-md bg-color-green text-gray-100 dark:text-black text-sm hover:bg-opacity-80'>Log In</button>
        </div>
