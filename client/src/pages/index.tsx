    ...
    return (
        <div className='bg-gray-200 dark:bg-black flex flex-col h-screen'>
            ...
            <div className='mb-5 flex flex-col max-w-[350px] sm:max-w-sm lg:max-w-md text-center mx-auto flex-grow justify-center gap-6 items-center'>
                ...
                <div className='cursor-pointer text-gray-100 dark:text-black shadow flex items-center gap-3 px-7 py-4 rounded-full font-extrabold lg:font-bold bg-color-green uppercase hover:bg-opacity-80'>
                    <p>Get Started</p>
