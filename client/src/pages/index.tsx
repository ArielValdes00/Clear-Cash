    ...
    return (
        <div className='bg-gray-200 dark:bg-black flex flex-grow'>
            <div className='mb-5 flex flex-col text-center mx-auto justify-center gap-6 items-center max-w-[90%] sm:max-w-sm md:max-w-lg'>
                ...
                <Link href={'/dashboard'} className='cursor-pointer text-gray-200 dark:text-black shadow flex items-center gap-3 px-7 py-4 rounded-full font-extrabold lg:font-bold bg-color-green uppercase hover:bg-opacity-80'>
                    <p>Get Started</p>
